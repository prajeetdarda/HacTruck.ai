...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      <header className="lp-nav fixed top-0 inset-x-0 z-40">
        <div className="max-w-[1320px] mx-auto px-6 lg:px-10 h-16 flex items-center justify-between">
          <a href="#top" className="flex items-center gap-2.5">
            <svg viewBox="0 0 28 28" className="w-7 h-7">
              <rect
                ...
                fill="none" stroke="var(--fg)" strokeWidth="1.4"
              />
              <path
                d="M8 15 L13 15 L13 10 L20 10"
                stroke="var(--accent)" strokeWidth="1.6" fill="none" strokeLinecap="round"
              />
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <a href="#cta" className="lp-btn lp-btn-ghost !py-2 !px-4 text-[13px]">
              GitHub
            </a>
          </div>
        </div>
            ...
            <div className="relative reveal">
              <div className="relative mx-auto max-w-[560px] aspect-square">
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(closest-side, color-mix(in oklch, var(--accent) 20%, transparent), transparent 70%)",
                    filter: "blur(40px)",
                    transform: "scale(0.9)",
                  }}
                />
                ...
                >
                  ...
                  {/* steam from mug */}
                  <g opacity="0.6">
                    <path className="steam" style={{ animationDelay: "0s" }}
                      d="M120 280 q 4 -10 0 -22" stroke="var(--fg-3)" strokeWidth="2" fill="none" strokeLinecap="round" />
                    <path className="steam" style={{ animationDelay: "0.8s" }}
                      d="M132 280 q -4 -10 0 -22" stroke="var(--fg-3)" strokeWidth="2" fill="none" strokeLinecap="round" />
                    <path className="steam" style={{ animationDelay: "1.6s" }}
                      d="M144 280 q 4 -10 0 -22" stroke="var(--fg-3)" strokeWidth="2" fill="none" strokeLinecap="round" />
                  </g>

                  {/* mug */}
                  <g transform="translate(100,290)">
                    <rect x="0" y="0" width="48" height="58" rx="4"
                      fill="var(--panel-2)" stroke="var(--line-2)" strokeWidth="1.5" />
                  ...
                  <g transform="translate(330,280) rotate(-8)" filter="url(#lp-softShadow)" className="notif-glow">
                    <rect x="0" y="0" width="184" height="300" rx="28"
                      fill="#0B0E16" stroke="rgba(148,163,184,0.25)" strokeWidth="1.5" />
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-10">
          ...
          <div className="lp-panel overflow-hidden reveal" style={{ boxShadow: "var(--shadow)" }}>
            ...
            <div className="grid grid-cols-12">
              {/* roster */}
              <aside
                className="col-span-12 lg:col-span-3 border-b lg:border-b-0 lg:border-r"
              ...
              >
                ...
                <ul className="text-[14px]">
                  {(
                    ...
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full${t.pulse ? " dot-bad" : ""}`}
              ...
              {/* map */}
              <div
                className="col-span-12 lg:col-span-6 relative min-h-[380px] lg:min-h-[480px] overflow-hidden"
                style={{ background: "var(--bg-2)" }}
              >
                <div className="absolute inset-0 grid-bg grid-fade opacity-80 map-layer" />
                <svg
                  className="absolute inset-0 w-full h-full map-layer"
                  viewBox="0 0 800 480"
                ...
                >
                  ...
                  <g transform="translate(430,260)">
                    <circle r="5" fill="var(--bad)" className="dot-bad" />
                  </g>
              ...
              {/* priority */}
              <aside
                className="col-span-12 lg:col-span-3 border-b lg:border-b-0 lg:border-l"
                style={{ borderColor: "var(--line)" }}
              >
                <div className="px-5 py-4 lp-line-b flex items-center justify-between">
                ...
                <div className="p-5 space-y-3">
                  <div className="rounded-xl p-4" style={{
                    ...
                    <button
                      className="lp-btn mt-3 !py-1.5 !px-3 text-[12px]"
            ...
            {[
              {
                ...
                body: "Half the trucks show \"last ping 42 min ago.\" The coffee hasn't even finished brewing.",
              },
              {
                time: "11:00",
                title: "Shipper calls first.",
                body: "They want an ETA you don't have. Every minute of silence is trust leaking out.",
              },
              {
                time: "17:00",
                title: "Paper chase.",
                body: "You stay until 19:30 stitching a day you already lived, so billing goes out clean.",
              },
            ].map((item) => (
              <div key={item.time}>
                <div className="mono text-[12px] ink-3 tracking-widest">{item.time}</div>
                <h3 className="mt-3 display d-md" style={{ fontSize: "clamp(22px, 2vw, 30px)" }}>
                  {item.title}
                </h3>
      ...
      {/* ════ TECH STRIP ════ */}
      <section
        className="relative py-16 lp-line-t lp-line-b"
        style={{ background: "var(--bg-2)" }}
      >
        <div className="max-w-[1320px] mx-auto px-6 lg:px-10">
          <div className="flex items-center justify-between flex-wrap gap-6">
            ...
            <div className="flex flex-wrap items-center gap-x-10 gap-y-4 ink">
              {["Next.js", "React", "Mapbox", "OpenAI", "Tailwind", "Postgres"].flatMap((tech, i, arr) =>
                i < arr.length - 1
                  ? [
            ...
            <div className="grid lg:grid-cols-[1.3fr_1fr] gap-12 items-center relative">
              <div>
                ...
                <h2 className="display d-lg mt-3">
                  Built at <span className="ochre">ASU GlobeHack 2026.</span>
                </h2>
                <p className="mt-6 text-[17px] ink-2 leading-snug max-w-[46ch]">
                  48-hour sprint. Real carriers interviewed on day one.
                  Shipped a dispatch intelligence layer that four judges — and one tired dispatcher —
                  signed off on.
                </p>
                <div className="mt-10 grid grid-cols-3 gap-6 max-w-md">
                  {[
                    { label: "Placement", value: "Track winner" },
                    { label: "Sprint",    value: "48 hours"    },
                    { label: "Team",      value: "4 builders"  },
                  ].map((s) => (
                    <div key={s.label}>
              ...
              <div className="relative aspect-square max-w-[340px] mx-auto">
                <svg viewBox="0 0 400 400" className="w-full h-full">
                  ...
                  <polygon
                    points="200,80 300,138 300,262 200,320 100,262 100,138"
                    fill="var(--panel-2)"
                    stroke="var(--accent)"
                    strokeWidth="1.5"
                  />
                  ...
                  <text fontFamily="JetBrains Mono" fontSize="12" letterSpacing="4" fill="var(--fg-3)">
                    <textPath href="#lp-arcTop" startOffset="50%" textAnchor="middle">
                      ASU · GLOBEHACK · 2026
                    </textPath>
                  </text>
                  <text fontFamily="JetBrains Mono" fontSize="12" letterSpacing="4" fill="var(--fg-3)">
                    <textPath href="#lp-arcBot" startOffset="50%" textAnchor="middle">
      ...
      <section id="cta" className="relative py-32 lg:py-40 text-center">
        <div className="max-w-[780px] mx-auto px-6 lg:px-10">
          <h2 className="display d-xl reveal">
            Help Maria make <br />
            <span className="ochre">smarter calls</span>, faster.
          </h2>
          ...
          <div className="mt-10 flex flex-wrap gap-3 justify-center reveal">
            <a href="https://github.com" className="lp-btn lp-btn-primary">
            ...
            <a href="#dashboard" className="lp-btn lp-btn-ghost">Replay demo</a>
          </div>
        </div>
      </section>
      ...
      <footer className="lp-line-t py-10" style={{ background: "var(--bg-2)" }}>
        <div className="max-w-[1320px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            <svg viewBox="0 0 28 28" className="w-5 h-5">
              <rect x="2" y="2" width="24" height="24" rx="6"
                fill="none" stroke="var(--fg)" strokeWidth="1.4" />
              <path d="M8 15 L13 15 L13 10 L20 10"
                stroke="var(--accent)" strokeWidth="1.6" fill="none" strokeLinecap="round" />
            </svg>
