            ...
            <div className="flex items-center gap-1">
              {state.mapRingFilter && (
                <button
                  ...
                  className="flex items-center gap-1 rounded-lg px-2 py-1.5 text-xs text-zinc-600 outline-none transition-colors hover:bg-black/[0.04] hover:text-zinc-900 focus-visible:ring-2 focus-visible:ring-[var(--ring-focus)] dark:text-zinc-500 dark:hover:bg-white/5 dark:hover:text-zinc-300"
